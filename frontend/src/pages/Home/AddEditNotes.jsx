...
const editNote = async () => {
  ...
  try {
    ...
    const res = await axios.put(
      `http://127.0.0.1:8000/edit?note_id=${noteId}`,  // Backend route to edit a note, passing note_id as a query parameter
  ...
  const addNewNote = async () => {
    try {
      ...
      const res = await axios.post(
        "http://127.0.0.1:8000/add",  // Backend route to add a new note
